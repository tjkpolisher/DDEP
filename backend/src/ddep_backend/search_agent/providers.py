...
CURATED_RESOURCES: list[LearningResourceCandidate] = [
    ...
    LearningResourceCandidate(
        ...
        source_type="official_docs",
        difficulty="advanced",
        concept_tags=["attitude_control", "pid"],
    ...
    LearningResourceCandidate(
        ...
        source_type="official_docs",
        difficulty="intro",
        concept_tags=["imu", "sensor_fusion", "ekf"],
        prerequisite_tags=[],
    ...
    LearningResourceCandidate(
        ...
        source_type="official_docs",
        difficulty="intermediate",
        concept_tags=["mavlink", "telemetry", "software_integration"],
        prerequisite_tags=["serial_link"],
    ...
    LearningResourceCandidate(
        ...
        source_type="official_docs",
        difficulty="intermediate",
        concept_tags=["path_planning", "navigation", "autonomous_ai"],
        prerequisite_tags=["ros2"],
